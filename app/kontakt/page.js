                ...
                <>
                  ...
                  >
                    ...
                    <input
                      ...
                      name="customer_name"
                      className="infoForm col-span-1 h-12 border-b border-b-black   border-l-0 border-t-0 border-r-0  md:placeholder:absolute md:placeholder:top-0 placeholder:left-2  placeholder:text-black placeholder:text-sm placeholder:font-medium focus:outline-none focus:ring-0"
